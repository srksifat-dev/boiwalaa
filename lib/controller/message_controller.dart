...
class MessageController extends GetxController {
  var messageList = List<MessageModel>.empty(growable: true).obs;
  var clicked = false;
  ...
  void showMessageOnTheFly(
    ...
    Get.snackbar("", "",
        ...
        messageText: isCopyable
            ? "$startingMessageBody '$coupon' $endingMessageBody"
                .text
                .white
                .make()
            : "$startingMessageBody".text.white.make(),
